INSTALL_FILES := ackrc aptitude/config autojump $(wildcard bazaar/plugins/*) $(filter-out bazaar/plugins,$(wildcard bazaar/*)) $(wildcard byobu/*) byobu/.screenrc byobu/.tmux.conf gemrc gitconfig gitignore.global gvimrc hgrc irbrc lib oh-my-zsh pdbrc pentadactyl pentadactylrc railsrc screenrc screenrc.common subversion/servers terminfo tmux.conf tmux.common.conf vim vimrc vimpagerrc Xresources xsessionrc
