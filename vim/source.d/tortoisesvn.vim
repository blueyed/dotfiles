...
map <silent> <Leader>td :w<CR>:silent !start TortoiseProc.exe /command:diff /path:"%:p" /notempfile /closeonend<CR>

" Save current buffer and launch Tortoise SVN's revision graph
map <silent> <Leader>tr :w<CR>:silent !start TortoiseProc.exe /command:revisiongraph epath:"%:p" /notempfile /closeonend<CR>
...
map <silent> <Leader>tl :w<CR>:silent !start TortoiseProc.exe /command:log /path:"%:p" /notempfile /closeonend<CR>
